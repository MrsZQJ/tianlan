...
$light = $_POST['light'];
$slug = $_POST['slug'];
$feature1 = $_FILES['feature9'];
$feature2 = $_FILES['feature10'];
$feature3 = $_FILES['feature11'];
$feature4 = $_FILES['feature12'];
...
$sql = "insert into t_product_piston (title,brand,engine,part,centerLength,aperture,bigBodywide,smallEnddiameter,smallEndwide,light,slug,feature1,feature2,feature3,feature4,category,created,status,content) 
